...
type GetSVPokemonsPresenter struct{}

func NewGetSVPokemonsPresenter() usecase.GetSVPokemonsPresenter {
	return &GetSVPokemonsPresenter{}
}

func (p *GetSVPokemonsPresenter) Output(pokemons []entity.Pokemon) usecase.GetSVPokemonsOutput {
	output := usecase.GetSVPokemonsOutput{
