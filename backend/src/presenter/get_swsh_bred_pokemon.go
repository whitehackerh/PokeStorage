...
type GetSwShBredPokemonsPresenter struct{}

func NewGetSwShBredPokemonsPresenter() usecase.GetSwShBredPokemonsPresenter {
	return &GetSwShBredPokemonsPresenter{}
}

func (p *GetSwShBredPokemonsPresenter) Output(entities []entity.SwShBredPokemon) usecase.GetSwShBredPokemonsOutput {
	output := usecase.GetSwShBredPokemonsOutput{
		BredPokemons: []api_schema.SwShBredPokemon{},
	}
	for _, bredPokemon := range entities {
		...
		output.BredPokemons = append(output.BredPokemons, api_schema.SwShBredPokemon{
